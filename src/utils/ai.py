...
def analyze_user_interest(article: dict, user: dict) -> str:
    ...
    user_tags = user.get('tags', []) # Should be a list of interest strings? Or structured?
    # Assuming user interests are stored in 'tags' (list of strings) or we use a new field.
    # The previous code added 'tags' to user object in login.
    # Also 'interests_prompt' if available.
